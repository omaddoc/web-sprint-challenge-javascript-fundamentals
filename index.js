...
// Because closure makes this possible. Nested Child functions have access to their parents properties but not vise-versa.
...
function lowerCaseNames(arr) {
  /*Your Code Here*/
  const lowerCaseNames = arr.map((animal) => {
...
CuboidMaker.prototype.surfaceArea = function () {
  return (
    2 * (this.length * this.width * this.height + this.width * this.height)
  );
};
